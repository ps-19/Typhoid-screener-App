              ...
              <div className="col-12">
                ...
                >
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <img
                        src={img1}
                        className="img-fluid aboutUsphoto"
                        alt=""
                      />
                    </div>
                ...
                <div className="heroText d-flex flex-column justify-content-center aboutUsphoto2">
                  ...
                  <p className="mb-4">
                    ...
                    Yaoundé, Cameroon. The aim of MboaLab is to catalyse
                    sustainable local development and improve people’s living
                    conditions through open science..
                  </p>
            ...
            <div className="row">
              <div className="col-lg-6 col-md-6 col-12">
                ...
                <p>
                  ...
                  profession or health care related websites. You can support us
                  a little via PayPal if this template is good and useful for
                  your work.
                </p>
              </div>
              ...
              <div className="col-lg-4 col-md-5 col-12 mx-auto">
                <div className="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                  <p className="featured-text">
                    <span className="featured-number">2</span> Years
                    <br /> of Experiences
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-6 ps-0">
                <img
                  src={img4}
                  className="img-fluid galleryImage aboutUsImg"
                  alt="get a vaccine"
              ...
              <div className="timeline">
                <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
                  ...
                  <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                    <svg
                      ...
                      height="45"
                      fill="currentColor"
                      className="bi bi-clipboard2-pulse-fill timeline-icons svgs"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
                  <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                    ...
                    <p>
                      ...
                      redistribute the template ZIP file for a download purpose
                      on any other{" "}
                      <NavLink
                  ...
                  <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                    <svg
                      ...
                      height="40"
                      fill="currentColor"
                      className="bi bi-book timeline-icons svgs"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
                  <div className="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                    ...
                    <p>
                      Phasellus eleifend, urna interdum congue viverra, arcu
                      neque ultrices ligula, id pulvinar nisi nibh et lacus.
                      Vivamus gravida, ipsum non euismod tincidunt, sapien elit
                      fermentum mi, quis iaculis enim ligula at arcu.
                    </p>
                  </div>
                  ...
                  <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                    <svg
                      ...
                      height="40"
                      fill="currentColor"
                      className="bi bi-file-medical-fill timeline-icons svgs"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes my-lg-5 my-4">
                  <div className="col-9 col-md-5 ms-md-4 ms-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                    ...
                    <p className="mb-0 pb-0">
                      Fusce vestibulum euismod nulla sed ultrices. Praesent
                      rutrum nulla vel sapien euismod, quis tempus dui placerat.
                    </p>
                  ...
                  <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                    <svg
                      ...
                      height="50"
                      fill="currentColor"
                      className="bi bi-balloon-heart-fill timeline-icons svgs"
                      viewBox="0 0 16 16"
                    >
                      <path
                        fill-rule="evenodd"
                ...
                <div className="row g-0 justify-content-end justify-content-md-around align-items-start timeline-nodes">
                  <div className="col-9 col-md-5 me-md-4 me-lg-0 order-3 order-md-1 timeline-content bg-white shadow-lg">
                    ...
                    <p>
                      ...
                      your inbox, please visit our{" "}
                      <NavLink rel="nofollow" to="/contact" target="_parent">
                        contact page
                      </NavLink>{" "}
                  ...
                  <div className="col-3 col-sm-1 order-2 timeline-icons text-md-center">
                    <svg
                      ...
                      height="45"
                      fill="currentColor"
                      className="bi bi-person-square timeline-icons svgs"
                      viewBox="0 0 16 16"
                    >
